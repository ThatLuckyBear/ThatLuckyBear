...
X SPOTSLIME	*SLIME* 	*BEAST*

----------------------------------------

X WINGSLIME	*SLIME* 	*BIRD*

----------------------------------------

X TREESLIME	*SLIME* 	*PLANT*
...
X BOXSLIME	*SLIME* 	*MATERIAL*

----------------------------------------

X PEARLGEL	*SLIME* 	*WATER*
...
X SLIMEBORG	DrakSlime	Swordgon
...
X SLABBIT		*SLIME* 	Skullroo

----------------------------------------

X KINGSLIME	SpotKing 	GreatDrak
				BattleRex
				Divinegon
				Unicorn
				KingLeo
		...
		*SLIME* 	*BOSS*
		...
		Slime		Slime		(offspring must be at least +5)

----------------------------------------

X METALY		*SLIME* 	MetalDrak

----------------------------------------

X METABBLE	Metaly 		Metaly
				WonderEgg

----------------------------------------

X SPOTKING	KingSlime	GreatDrak
		MetalKing 	BattleRex	
				Divinegon
				Unicorn
				KingLeo
		...
		SpotSlime 	SpotSlime	(offspring must be at least +5)

----------------------------------------

X TROPICGEL	Slime 		PillowRat
				Mommonja
...
X METALKING	SpotKing	MetalDrak
		KingSlime 	
...
X GOLDSLIME	SpotKing	GoldGolem
		KingSlime
		MetalKing
...
X GRANSLIME	GoldSlime 	DarkMate
				GoldSlime
				DeathMore1
